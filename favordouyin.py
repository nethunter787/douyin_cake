...
user_url = 'https://www.douyin.com/user/MS4wLjABAAAA21RqW5mKwy7kZOHHzf_EwUrRYzgqOlo4WgwfN9lOSM0'
...
def getFavorCakeUrl(user_url,max_cursor = 0,count=10):
    ...
    api = 'https://www.douyin.com/aweme/v1/web/aweme/favorite/?%s'%(urllib.parse.urlencode(p)) # 该接口可以获取视频链接
...
while(usercakenum < 1000):
    time.sleep(0.2)
    res = getFavorCakeUrl(user_url,max_cursor)
